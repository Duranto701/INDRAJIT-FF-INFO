...
def get_credentials(region):
    region = region.upper()
    if region == "IND":
        return "4030113484", "948F19D733569868D691D7308B8E94ADEF54A93AA78A4060C2FC467A6EC50EED"
...
def get_jwt_token(region):
    ...
    jwt_url = f"https://ff-token-generator.vercel.app/token?uid={uid}&password={password}"
